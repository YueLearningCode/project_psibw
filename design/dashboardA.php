...
<head>
    ...
    <style>
        body { 
            ...
            background-color: #F4F7F6; /* Background Off-white Gambar 2 */
        }
        .sidebar-active {
            background-color: #004D39; /* Hijau Botol Gambar 2 */
            color: white !important;
        }
        .glass-card {
            background: white;
            border-radius: 2rem; /* Extra Rounded Gambar 2 */
...
<body class="text-slate-800">
    ...
    <aside class="fixed h-full w-[250px] bg-white border-r border-slate-100 flex flex-col z-50">
        ...
        <div class="p-6">
            <button onclick="logout()" class="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-bold text-rose-500 bg-rose-50 rounded-2xl hover:bg-rose-100 transition-all">
